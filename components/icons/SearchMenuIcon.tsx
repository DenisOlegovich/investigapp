...
const SearchMenuIcon = forwardRef<SVGSVGElement, ComponentPropsWithoutRef<'svg'>>((props, ref) => (
    <svg
    ...
    >
        ...
        <path
            fill="currentColor"
            fillRule="evenodd"
            d="M43.062 41.5h11.416v-3H40.06l3.001 3Zm-7.59-10h19.006v-3H36.03a14.754 14.754 0 0 1-.558 3Zm-.571-10h19.577v-3H33.182a14.77 14.77 0 0 1 1.719 3Z"
            clipRule="evenodd"
            opacity={0.5}
        />
    </svg>
