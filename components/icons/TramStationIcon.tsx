...
const TramStationIcon = forwardRef<SVGSVGElement, ComponentPropsWithoutRef<'svg'>>((props, ref) => (
    <svg
...
TramStationIcon.displayName = 'TramStationIcon'

export default TramStationIcon
